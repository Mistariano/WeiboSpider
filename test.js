!window.register_login_index && function () {
    ...
    (function () {
        if (!a)var a = function () {
            ...
            f.register = function (c, d, e) {
                if (!e || typeof e != "string")e = b;
                a[e] || (a[e] = {});
                var f = a[e], h = c.split("."), i = f, j = null;
                while (j = h.shift())if (h.length) {
                    i[j] === undefined && (i[j] = {});
                    i = i[j]
                } else if (i[j] === undefined)try {
                    if (e && e !== b) {
                        if (c === "core.util.listener") {
            ...
            f.unRegister = function (c, d) {
                if (!d || typeof d != "string")d = b;
                var e = a[d], f = c.split("."), h = e, i = null;
                while (i = f.shift())if (f.length) {
                    if (h[i] === undefined)return !1;
                    h = h[i]
                } else if (h[i] !== undefined) {
                    delete h[i];
                ...
                return {
                    register: function (b, c, d) {
                        ...
                        if (a[c] && a[c][g] && a[c][g].length > 0) {
                            i = a[c][g];
                            i.data_cache = h;
                            for (j = 0, k = i.length; j < k; j++)b.push({channel: c, evt: g, func: i[j], data: h});
                            d()
                        }
                    }, remove: function (b, c, d) {
                        if (a[b] && a[b][c])for (var e = 0, f = a[b][c].length; e < f; e++)if (a[b][c][e] === d) {
        ...
        a.register("core.json.queryToJson", function (a) {
            return function (c, d) {
                var e = a.core.str.trim(c).split("&"), f = {}, g = function (a) {
                    return d ? decodeURIComponent(a) : a
                };
                for (var h = 0, i = e.length; h < i; h++)if (e[h]) {
                    var j = e[h].split("="), k = j[0], l = j[1];
                    if (j.length < 2) {
                        l = k;
                        k = "$nullName"
                    }
        ...
        a.register("core.json.jsonToQuery", function (a) {
            ...
            return function (a, d) {
                var e = [];
                if (typeof a == "object")for (var f in a) {
                    if (f === "$nullName") {
                        e = e.concat(a[f]);
                        continue
                    }
                    if (a[f]instanceof Array)for (var g = 0, h = a[f].length; g < h; g++)e.push(f + "=" + b(a[f][g], d)); else typeof a[f] != "function" && e.push(f + "=" + b(a[f], d))
                }
        ...
        a.register("core.util.URL", function (a) {
            return function (c, d) {
                var e = a.core.obj.parseParam({
                    isEncodeQuery: !1,
                    isEncodeHash: !1
                }, d || {}), f = {}, g = a.core.str.parseURL(c), h = a.core.json.queryToJson(g.query), i = a.core.json.queryToJson(g.hash);
                ...
                f.setParams = function (a) {
                    for (var b in a)f.setParam(b, a[b]);
                    return this
                };
                ...
                f.valueOf = f.toString = function () {
                    var c = [], d = a.core.json.jsonToQuery(h, e.isEncodeQuery), f = a.core.json.jsonToQuery(i, e.isEncodeQuery);
                    if (g.scheme != "") {
                        c.push(g.scheme + ":");
                        c.push(g.slash)
                    }
        ...
        a.register("core.io.scriptLoader", function (a) {
            ...
            return function (e) {
                ...
                if (h.url == "")throw"scriptLoader: url is null";
                ...
                f.src = a.core.util.URL(h.url, {isEncodeQuery: h.isEncode}).setParams(h.args).toString();
        ...
        a.register("core.io.jsonp", function (a) {
            return function (c) {
                var d = a.core.obj.parseParam({
                    ...
                    isEncode: !1,
                    varkey: "callback"
                }, c), e = -1, f = d.responseName || "STK_" + a.core.util.getUniqueKey();
                d.args[d.varkey] = f;
                var g = d.onComplete, h = d.onTimeout;
                window[f] = function (a) {
                    if (e != 2 && g != null) {
                        e = 1;
                        g(a)
        ...
        a.register("jobs.qrcode_login", function (a) {
            ...
            var j = function (g) {
                a.core.io.jsonp({
                    ...
                    args: {entry: d.entry, size: d.qrcode_size},
                    onComplete: function (a) {
                        if (!a || a.retcode != 2e7)g(a); else {
                            var b = a.data;
                ...
                a.core.io.jsonp({
                    ...
                    onTimeout: function () {
                        c.fire("login_failure", {retcode: -1, msg: "鐧诲綍瓒呮椂"})
                    },
                    isEncode: !0,
                    varkey: "callback"
                })
                ...
                if (e == 0)c({result: !0}); else {
                    var f = setTimeout(function () {
                        e = -1;
                        c({result: !1})
                    }, d.crossdomain_timeout);
                    for (var g in b.crossDomainUrlList)a.core.io.scriptLoader({
    ...
    STK.register("common.login.sso.qrcodebridge", function (a) {
        var b = window.SINA_QRCODE_LOGIN, c = a.common.channel.sso.qrcode;
        return function (a) {
            var d = !1, e = {
                init: function () {
                    if (!d) {
                    ...
                    for (var a in e.send)b.register(a, e.send[a]);
                    for (var a in e.handle)c.register(a, e.handle[a])
                }, unbind: function () {
                }, send: {
    ...
    STK.pageletM.register("pl.plugin.sso.qrcode.index", function (a) {
        return a.common.login.sso.qrcodebridge()
    });
    (function () {
        if (!a)var a = function () {
            var a = {}, b = "theia", c = [], d = 200, e;
        ...
        a.register("core.json.merge", function (a) {
            ...
            return function (b, c, f) {
                var g = a.core.obj.parseParam({isDeep: !1}, f);
                ...
                switch (typeof o) {
                    ...
                    case"object":
                        ...
                        if (Object.prototype.toString.apply(o) === "[object Array]") {
                            l = o.length;
                            for (c = 0; c < l; c += 1)n[c] = j(c, o) || "null";
                            g = n.length === 0 ? "[]" : e ? "[\n" + e + n.join(",\n" + e) + "\n" + m + "]" : "[" + n.join(",") + "]";
                            e = m;
                            return g
                        }
                        ...
                        } else for (d in o)if (Object.hasOwnProperty.call(o, d)) {
                            g = j(d, o);
                            g && n.push(i(d) + (e ? ": " : ":") + g)
                        }
                        g = n.length === 0 ? "{}" : e ? "{\n" + e + n.join(",\n" + e) + "\n" + m + "}" : "{" + n.join(",") + "}";
        ...
        (function () {
            ...
            for (var d in c)c[d] && a.regShort(d, c[d])
        })();
        a.register("core.util.listener", function (a) {
            return function () {
                var a = {}, b = [], c, d = function () {
        ...
        a.register("core.arr.foreach", function (a) {
            ...
            return function (e, f) {
                if (a.core.arr.isArray(e) || e.length && e[0] !== undefined)return b(e, f);
                if (typeof e == "object")return c(e, f);
                return null
            }
        });
        a.register("common.util.request", function (a) {
            ...
            b.createIframe = function () {
                var a = "iframe" + (new Date).getTime(), c = a;
            ...
            b.createForm = function (b, d, e) {
                var f = a.C("form"), g = "form" + (new Date).getTime();
                f.id = g;
            ...
            return function (d) {
                d = a.core.obj.parseParam({url: "", data: null, complete: null, fail: null, timeout: null}, d);
                var e = b.createIframe(), f, g = function () {
                    try {
                        var i = e.contentWindow, j = i.location.href, k = b.getDocOfIframe(e), l = k.body.getElementsByTagName("textarea")[0];
                        clearTimeout(f);
                        try {
        ...
        a.register("comp.plugin", function (a) {
            var b = a.common.channel.plugin, c = a.common.util.request, d = {}, e = {};
            e.canPostMessage = !1;
            var f = {
                iframeUrl: "http://login.sina.com.cn/plugin_proxy.html",
                proxyUrl: "",
            ...
            d.init = function (c) {
                ...
                if (!e.canPostMessage && !f.proxyUrl)b.fire("getinfo_error", {
                    code: "-3",
            ...
            e.isIE = function () {
                var a = navigator.userAgent.toLowerCase();
                if (/msie/.test(a)) {
                    var b = a.match(/msie (\d+)/), c = parseInt(b[1]);
                    return c
                }
                return !1
            };
            e.createIframe = function (b, c) {
                var d = "plugin_sso_iframe" + (new Date).getTime(), f = d;
                e.proxyDiv = a.C("div");
            ...
            e.handleMsgEvt = function (c) {
                if (!e.canPostMessage || c.origin == "http://login.sina.com.cn") {
                    clearTimeout(e.getInfosTimeout);
                    e.getInfosTimeout = null;
                    clearTimeout(e.getTicketTimeout);
                    e.getTicketTimeout = null;
                    if (!c || !c.data || e.canPostMessage && c.origin != "http://login.sina.com.cn") {
                        b.fire("getinfo_error", {code: "-3", msg: "error data"});
                        return
                    }
                    var d = a.str2Json(decodeURIComponent(c.data));
                    if (!d || d.code != "0" && d.code != "-1")b.fire("getinfo_error", d); else if (d.type == "userinfo")b.fire("getuserinfo_ready", d); else if (d.type == "userticket") {
                        b.fire("getuserticket_ready", d);
                        a.removeEvent(window, "message", e.handleMsgEvt);
                        e.login(d)
                    }
                    if (!e.canPostMessage)try {
            ...
            e.login = function (c) {
                if (!!c) {
                    var d = c && c.data, h = d.uid, i = d.alc;
                    a.jsonp({
                        url: "//login.sina.com.cn/sso/login.php",
                        ...
                        onTimeout: function () {
                            b.fire("login_failure", {code: -1, msg: "鐧诲綍瓒呮椂"})
                        },
                        isEncode: !0,
                        varkey: "callback"
                    })
            ...
            e.crossdomain = function (b, c) {
                ...
                if (d == 0)c({result: !0}); else {
                    var e = setTimeout(function () {
                        d = -1;
                        c({result: !1})
                    }, f.crossdomain_timeout);
                    for (var g in b.crossDomainUrlList)a.scriptLoader({
                        url: b.crossDomainUrlList[g],
                        charset: "UTF-8",
                        args: {action: "login"},
                        onComplete: function () {
            ...
            e.getUserInfos = function () {
                ...
                e.getInfosTimeout || (e.getInfosTimeout = setTimeout(function () {
                    b.fire("getuserinfo_timeout", {code: "-2", msg: "getuserinfo_timeout"});
                    e.getInfosTimeout = null
                }, f.getinfos_timeout))
            };
            e.getUserTicket = function (c) {
                if (e.canPostMessage) {
                    var d = {type: "userticket", uid: c};
                    d = a.json2Str(d);
                    e.iframeHandle.postMessage(d, f.iframeUrl)
                }
                e.getTicketTimeout || (e.getTicketTimeout = setTimeout(function () {
                    b.fire("getuserticket_timeout", {code: "-2", msg: "getuserticket_timeout"});
                    e.getTicketTimeout = null
                }, f.getticket_timeout))
            };
            d.callbacks = {};
            ...
            d.getUserInfos = function () {
                var a = "", b = "";
                if (e.iframeDom)e.getUserInfos(); else {
                    if (e.canPostMessage)var b = f.iframeUrl; else {
                        a = e.setCallback();
            ...
            d.getUserTicket = function (a) {
                var b = "", c = "";
                if (e.iframeDom)e.getUserTicket(a); else {
                    if (e.canPostMessage)var c = f.iframeUrl; else {
                        b = e.setCallback();
    ...
    STK.register("common.login.sso.desktopbridge", function (a) {
        var b = window.SINA_USER_PLUGIN, c = a.common.channel.sso.desktop;
        return function (a) {
            var d = !1, e = {
                init: function () {
                    if (!d) {
                    ...
                    init: function () {
                        b.init({
                            iframeUrl: "http://login.sina.com.cn/plugin_proxy.html",
                            proxyUrl: "http://weibo.com/sso/desktopcallback",
    ...
    STK.pageletM.register("pl.plugin.sso.desktop.index", function (a) {
        return a.common.login.sso.desktopbridge()
    });
        ...
        return function (c) {
            var d, e, f, g, h = {
                init: function () {
                    ...
                    d = a.parseParam({template: b.FRAME}, c || {})
                }, build: function () {
                    ...
                    d = a.parseParam({el: null, box: null}, d || {});
                    if (!!d.el && !!a.isNode(d.el)) {
                        a.isNode(d.box) || (d.box = d.el);
                        f.msg.innerHTML = b.CONTENT + c;
                        e.show();
                        a.kit.dom.layoutPos(f.outer, d.box, {pos: "left-top"});
                        ...
                        a.core.dom.setXY(f.outer, {t: d.layerPos.t - d.layerPos.height - 3, l: d.layerPos.l - 2})
                    }
                }, hide: function () {
                    e.hide()
                }, destroy: function () {
            ...
            h.init();
            var j = {layer: e, show: h.show, hide: h.hide, domList: f, destroy: h.destroy};
            return j
        }
    });
    ...
    STK.register("common.setting.rule", function (a) {
        ...
        c.isRealName = function (a) {
            return /^[\u4e00-\u9fa5]{2,6}$/.test(a) ? !0 : /^[a-zA-Z]{2,20}$/.test(a) ? !0 : /[a-zA-Z0-9\u3000|\s|\t|\uff00-\uffff锝烇紒@#锟�%鈥︹€�&脳锛堬級鈥斺€斻€庛€忋€愩€戙€併€傗€樷€溿€娿€媆?\~\!\@\#\$\%\^\&\*\\\+\`\=\[\]\(\)\{\}\|\;\'\:\"\,\/\<\>]+/.test(a) ? !1 : !0
        };
    ...
    STK.register("common.setting.verifycode", function (a) {
        var b = {E01: "", E02: "#L{璇疯緭鍏ラ獙璇佺爜}", E03: "#L{楠岃瘉鐮佽緭鍏ユ湁璇瘆"};
        return function (c, d) {
            var e = function () {
    ...
    STK.register("common.setting.vsncode", function (a) {
        var b = {E01: "", E02: "#L{璇疯緭鍏ュ井鐩惧姩鎬佺爜}", E03: "#L{鍔ㄦ€佺爜鏈夎锛岃閲嶆柊杈撳叆}"};
        return function (c, d) {
            var e = function () {
                var a = g.value().replace(/^\s+|\s+$/g, ""), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
    ...
    STK.register("common.setting.username", function (a) {
        var b = {E01: "", E02: "#L{璇疯緭鍏ョ櫥褰曞悕}", E03: "#L{璇疯緭鍏ユ纭殑鐧诲綍鍚峿"};
        return function (c, d) {
            var e, f = function () {
                var a = h.value(), b = !1;
            ...
            }, g = {}, h = a.common.setting.control(c, d, {evtAct: g, check: f}), i = a.core.obj.sup(h, ["initPars"]);
            h.initPars = function () {
                i.initPars();
    ...
    STK.register("common.setting.passwordlite", function (a) {
        var b = {E01: "", E02: "#L{璇疯緭鍏ュ瘑鐮亇", E03: "#L{璇疯緭鍏ユ纭殑瀵嗙爜}"}, c;
        return function (d, e) {
            var f = function () {
                var a = j.value(), b = !1;
            ...
            }, j = a.common.setting.control(d, e, {evtAct: i, check: f}), k = a.core.obj.sup(j, ["initPars"]);
            j.initPars = function () {
                k.initPars();
    ...
    STK.register("common.login.form", function (a) {
        var b = ["username", "password", "verifycode", "vsncode"], c = a.core.util.templet, d = a.common.channel.sso.login, e = a.common.form.verifycodeSSO, f = a.core.evt.hotKey, g = a.kit.extra.textareaUtils, h = $CONFIG && $CONFIG.register_url || "http://weibo.com/signup/signup.php" + (Boolean(a.URL(window.location.href).getParam("c")) ? "?backurl=" + encodeURI(window.location.href) : ""), i = {
            ...
            cookie: {name: "un", conf: {expire: 240, path: "/", domain: window.location.hostname, encode: !0}},
            verifyCodeDelay: 3e5,
            savestateDelay: 600,
            errtipDelay: 5e3
        }, m, n = function (b) {
            if (!m) {
                m = [];
                for (var c in i.ERRTIP.CODE)m.push(c)
            }
            return a.inArray("" + b, m)
        };
        return function (f, h) {
            var m, o, p, q, r = {}, s, t, u, v = {yalogin: !1, nopwd: !1, unChecked: !1}, w = {
                init: function () {
                    w.parseParam();
                    w.parseDOM();
                    w.initPlugin();
                    ...
                    x.destroy();
                    u.destroy();
                    for (var a in r)r[a] && clearTimeout(r[a]);
                ...
                init: function () {
                    ...
                    var c;
                    for (var d in p)a.inArray(d, b) && j[d] && x.item(d);
                    ...
                    o.add(b, j[b](p[b], a.core.json.merge({hook: o}, _data)));
                    a.core.util.browser.MOZ && q.API.build({el: p[b], data: _data})
                    ...
                    for (var c in B)if (B[c].isVisible()) {
                        B[c].reset();
                        break
                    }
                    if (!a.password.state) {
                    ...
                    if (!p.prename_box)x.usernameBox(); else if (a.isNode(a.kit.dom.firstChild(p.prename_box))) {
                        v.yalogin = p.preuid.value;
                        o.ctls.username.value(p.prename.value);
                        a.setStyle(p.prename_box, "display", "");
                        x.checkUsername()
                    } else d.fire("yalogin.verify")
                    ...
                    for (var b in B)typeof a != "undefined" && a == b ? B[b].isVisible() ? B[b].reset() : B[b].enable() : B[b].isVisible() && B[b].disable()
                }, resetVerifycode: function (b) {
                    b && a.preventDefault(b.evt);
                    B.verifycode.reset();
                    return !1
                }, lock: function (b) {
                    if (typeof b != "undefined" && o.ctls[b])a.getStyle(p[b + "_box"], "display") != "none" && !o.ctls[b].pars.disabled && o.ctls[b].disabled(1); else for (var b in o.ctls)a.getStyle(p[b + "_box"], "display") != "none" && !o.ctls[b].pars.disabled && o.ctls[b].disabled(1)
                }, unlock: function () {
                ...
                enter: function (b) {
                    ...
                    if (b.keyCode === 13) {
                        ...
                        o.check();
                        var c = o.states(), d = b.target.getAttribute("node-type");
                        if (d == "password" && v.nopwd) {
                            x.errTip.show({username: {state: !1, msg: i.ERRTIP.CODE[4098]}});
                            return
                        }
                        d == "username" && !v.unChecked && x.checkUsername();
                        if (c[d].state == !1 && c[d].type == "empty")return;
                        for (var e in o.ctls)if (e != d && !o.ctls[e].pars.disabled && c[e].state == !1) {
                            setTimeout(function () {
                                g.setCursor(p[e])
                            }, 0);
                            return
                    ...
                    b = a.fixEvent(b);
                    var c = b.keyCode || b.which, d = b.shiftKey || c == 16 || !1;
                    (c >= 65 && c <= 90 && !d || c >= 97 && c <= 122 && d) && x.errTip.show({password: {msg: i.CAPSLOCK}})
                }
            }, A = {
                login: {
                    complete: function () {
                        ...
                        n(a.code) ? b = c(i.ERRTIP.CODE["" + a.code], {USERNAME: o.ctls.username.value()}) : b = !a.reason || a.reason === "" ? i.ERRTIP.CODE[9999] + "(" + a.code + ")" : a.reason;
                        var d = {};
                        d[a.type] = {msg: b, state: !1};
                        x.errTip.show(d, 1)
                    }
                }, logout: {
                    complete: function () {
                    ...
                    complete: function (a) {
                        ...
                        if (a.code && a.code == 4098) {
                            var b = {};
                            b[a.type] = {msg: i.ERRTIP.CODE["" + a.code], state: !1};
                            x.errTip.show(b);
                            v.nopwd = !0
                        }
                        v.unChecked = !0
                    ...
                    active: function (b) {
                        ...
                        a.kit.io.jsonp({
                            url: "http://" + (window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com") + "/a/aj/prelogin/status",
    ...
    STK.register("common.login.qrcode", function (a) {
        return function (b) {
            var c, d, e, f = a.kit.extra.language, g = a.common.channel.sso.qrcode, h = !0, i = {scanSucc: f('<div node-type="outer" style="width:208px" class="layer_form_tips"><div class="bg"><div node-type="inner" class="content qrcode_tips"><a class="W_ico12 icon_close" node-type="close"></a><div class="W_tips empty clearfix"><p class="icon"><span class="icon_succ"></span></p><p class="txt">#L{鎵弿鎴愬姛}锛�<br>#L{鐐瑰嚮鎵嬫満涓婄殑纭鍗冲彲鐧诲綍}</p></div></div><div class="arrow arrow_tips"></div></div>')}, j = {
                init: function () {
                    g.fire("set", {entry: "weibo", domain: "weibo.com"});
                    j.parseDOM();
                    j.initPlugins();
                    j.bind()
                }, parseDOM: function () {
                    ...
                    a.addEvent(c.icon_tips, "mouseover", j.tips.show);
                    a.addEvent(c.icon_tips, "mouseout", j.tips.hide);
                    for (var b in j.handle)g.register(b, j.handle[b]);
                    a.custEvent.define(k, ["enable", "disable"]);
                    a.custEvent.add(k, "enable", j.enable);
                    a.custEvent.add(k, "disable", j.disable)
                }, initPlugins: function () {
                    d = a.ui.mod.layer(i.scanSucc);
                    e = d.getDom("close");
                    a.addEvent(e, "click", d.hide)
                }, unbind: function () {
                }, handle: {
                    getQRcode_success: function (a) {
                        c.qrcode_src.src = a.data.image
                    }, qrcode_scanned: function (c) {
                        var e = d.getDom("outer"), f = a.core.dom.position(b);
                        a.core.dom.setStyle(e, "top", f.t - 32 + "px");
                        a.core.dom.setStyle(e, "left", f.l - 10 + "px");
                        if (h) {
                    ...
                    c.qrcode_src.src ? g.fire("start") : j.getQRcode()
                }, disable: function () {
                    g.fire("cancel")
                }, tips: {
                    show: function () {
                        c.icon_ask.style.display = ""
                    }, hide: function () {
                        c.icon_ask.style.display = "none"
                    }
                }, destroy: function () {
                }
            }, k = {enable: j.enable, disable: j.disable};
            j.init();
            return k
        }
    });
    STK.register("common.login.desktop", function (a) {
        var b = a.kit.extra.language, c = a.core.util.templet, d = {
            FRAME: b('<div node-type="logged_loading" style="display:none" class="logged_loading"></div><div node-type="logged_tip" style="display:none" class="wrong_tips"></div><div node-type="logged_acc_show" class="logged_acc_show"><p class="logged_tips W_tc S_txt2">#L{鐐瑰嚮澶村儚鐧诲綍浣犵殑寰崥}</p><div class="logged_acc_show_bg"><div class="logged_accs clearfix" node-type="logged_userlist"></div></div><a node-type="arrow" action-type="left" style="display:none" class="acc_arrow l_arrow" href="jsvascript:void(0);"></a><a node-type="arrow" action-type="right" style="display:none" class="acc_arrow r_arrow" href="jsvascript:void(0);"></a></div><div class="register_tips"><em class="S_txt2">#L{杩樻病鏈夊井鍗氾紵}</em><a target="_blank" href="' + ($CONFIG && $CONFIG.register_url || "http://weibo.com/signup/signup.php") + '">#L{绔嬪嵆娉ㄥ唽}</a>' + "</div>"),
        ...
        return function (b) {
            var e = a.common.channel.sso.desktop, f = !1, g, h, i = {
                ...
                init: function () {
                    ...
                    for (var c in n.domEvts)h.add(c, "click", n.domEvts[c]);
                    a.custEvent.define(o, ["desktop", "refresh"]);
                    for (var c in n.castEvts)a.custEvent.add(o, c, n.castEvts[c]);
                    for (var c in n.handle)e.register(c, n.handle[c])
                }, handle: {
                    getuserinfo_ready: function (b) {
                        ...
                        } else a.custEvent.fire(o, "desktop", 0)
                        ...
                        nodes.logged_tip.innerHTML = c(d.TIP, {MSG: b});
                        n.access("tip")
                    ...
                    back: function (b) {
                        ...
                        if (!i.on_scroll) {
                            ...
                            a.core.ani.tween(nodes.logged_userlist, {
                                duration: i.play_duration, end: function () {
                                    a.setStyle(nodes.arrow[1], "display", "");
                                    i.current_acc <= 0 && a.setStyle(nodes.arrow[0], "display", "none");
                                    i.on_scroll = !1
                                }
                            }).finish({marginLeft: i.current_acc * i.small_acc_width * -1})
                        }
                    }, right: function (b) {
                        a.preventDefault(b.evt);
                        if (!i.on_scroll) {
                    ...
                    if (!!a.inArray(b, j))for (var c in j)a.setStyle(nodes["logged_" + j[c]], "display", b == j[c] ? "" : "none")
                }, castEvts: {
                    refresh: function () {
                        n.refresh()
                    }
                    ...
                    var f = [];
                    for (var h in g)f.push(c(d.USER, {NICKNAME: g[h].name, AVATOR: g[h][e], UID: g[h].uid}));
    ...
    STK.register("common.setting.mobile", function (a) {
        var b = {
            E01: "",
            E02: "#L{鐩墠鏀寔澶ч檰銆佹腐婢冲彴鎵嬫満鍙锋敞鍐寎",
            E03: "#L{璇疯緭鍏ユ墜鏈哄彿鐮亇",
            E04: "#L{鎵嬫満鍙烽暱搴�11浣嶏紝浠�13/14/15/17/18寮€澶磢"
        };
        return function (c, d) {
            var e = function () {
                var a = g.value(), b = !1;
                ...
                focus: function () {
                    ...
                    if (!(b && g.cache_value == b && g.pars.proxy && g.pars.iokey)) {
                        ...
                        if (g.pars.iodelay === 0 && !g.pars.proxy && !g.pars.iokey) {
                            e();
                            g.fire()
                        } else ioDelay = setTimeout(function () {
                            e();
                            if (g.msg.state && g.pars.proxy && g.pars.iokey) {
                                ...
                                }, {type: g.type, value: encodeURIComponent(g.value())})
                            }
                            g.fire()
                        }, g.pars.iodelay)
                    }
    ...
    STK.register("common.setting.activation", function (a) {
        var b = {E01: "", E02: "#L{璇疯緭鍏ョ煭淇℃縺娲荤爜}", E03: "#L{婵€娲荤爜杈撳叆鏈夎}"};
        return function (c, d) {
            var e = function () {
                var a = g.value().replace(/^\s+|\s+$/g, ""), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
    ...
    STK.register("common.setting.timer", function (a) {
        var b = {ss: 1, mm: 60, hh: 3600, dd: 86400};
        return function (c, d) {
            var e = {}, f, g, h = {
                init: function () {
                    f = a.parseParam({time: 0, loop: "ss"}, c);
                    d = d || function () {
                    }
                }, start: function (a) {
                    var a = f.time, c = function () {
                        d({
                            last: a,
    ...
    STK.register("common.trans.sso.message", function (a) {
        ...
        c("send_sms", {url: "http://login.sina.com.cn/sso/msglogin", requestMode: "jsonp", varkey: "callback"});
        return b
    });
    STK.register("common.login.message", function (a) {
        var b = ["mobile", "activation"], c = a.core.util.templet, d = a.common.channel.sso.login, e = a.common.trans.sso.message, f = a.kit.extra.textareaUtils, g = {
            TIPS: {
                SEND_SMS_SUCCESS: "#L{楠岃瘉鐮佸彂閫佹垚鍔燂紝60绉掑唴鏈敹鍒拌閲嶆柊鑾峰彇}",
                SEND_SMS_ERROR: '#L{楠岃瘉鐮佹棤娉曞彂閫侊紝璇风◢<a href="javascript:window.location.reload()">鍒锋柊椤甸潰</a>鍚庡啀璇晑',
                LOGIN_SMS_ERROR: "#L{楠岃瘉鐮佽緭鍏ユ湁璇瘆",
                MOBILE_FORMAT_ERROR: "#L{璇疯緭鍏ユ纭殑鎵嬫満鍙穧",
                SEND_SMS_TOOFAST: "#L{鍙戦€侀獙璇佺爜杩囬锛岃绋嶅悗鍐嶈瘯}",
                MOBILE_NOT_REGISTER: '#L{姝ゅ彿鐮佸皻鏈敞鍐岋紝<a href="http://weibo.com/signup/signup.php">绔嬪嵆娉ㄥ唽</a>}',
                ACTIVATION_EMPTY: "#L{璇疯緭鍏ョ煭淇￠獙璇佺爜}"
            },
            ERRTIP: {CODE: a.common.form.ssoErrCode},
            SUBMIT: {NORMAL: "#L{鐧诲綍}", ONSUBMIT: '<b class="loading"></b>#L{鐧诲綍}'}
        }, h = function () {
            ...
            if (!i) {
                i = [];
                for (var c in g.ERRTIP.CODE)i.push(c)
            }
            return a.inArray("" + b, i)
        };
        return function (i, k) {
            var l, m, n, o, p, q, r = {}, s = {unChecked: !1}, t = null, u = {
                init: function () {
                    u.parseParam();
                    u.initPlugins();
                    u.bind()
                    ...
                    for (var b in u.domEvt)o.add(b, "click", u.domEvt[b]);
                    ...
                    for (var b in u.domEvt)o.remove(b, "click", u.domEvt[b]);
                    o.destroy();
                    ...
                    btn_sms_activation: function (b) {
                        ...
                        if (!c.state)v.errTip.show({mobile: c}); else if (!s.unChecked) {
                            t = v.sendSMS;
                            h.reset();
                            v.checkUsername()
                        } else v.sendSMS()
                    ...
                    v.errTip.hide();
                    p && p.stop();
                    for (var a in l.ctls)l.ctls[a].value(l.ctls[a].pars.text)
                }, destroy: function () {
                    u.unbind();
                    v.destroy();
                    q.destroy();
                ...
                init: function () {
                    ...
                    for (var e in b) {
                        ...
                        if (a.common.setting[d]) {
                            ...
                            l.add(d, a.common.setting[d](m[d], a.core.json.merge({hook: l}, c)));
                            a.core.util.browser.MOZ && n.API.build({el: m[d], data: c})
                        }
                    }
                    ...
                    textCopy: function (b, c) {
                        ...
                        a.inArray(c.el, [m.mobile, m.password]) && (b.type == "focus" ? a.addClassName(c.el.parentNode, "W_input_focus2") : b.type == "blur" && a.removeClassName(c.el.parentNode, "W_input_focus2"))
                    }
                }, errTip: {
                    show: function (a, b) {
                        for (var c in a)if (!a[c].state) {
                            var d = "" + a[c].msg;
                            c == "username" && (c = "mobile");
                            if (c == "mobile")switch (a[c].code) {
                                case"E04":
                                    d = g.TIPS.MOBILE_FORMAT_ERROR
                            }
                            if (c == "activation")switch (a[c].code) {
                                case"E02":
                    ...
                    if (typeof a != "undefined" && l.ctls[a])l.ctls[a].disabled(1); else for (var a in l.ctls)l.ctls[a].disabled(1)
                }, unlock: function () {
                    for (var b in l.ctls)a.getStyle(m[b + "_box"], "display") != "none" && l.ctls[b].pars.disabled && l.ctls[b].disabled(0)
                }, submit: {
                    active: function () {
                        r.checkUsername && clearTimeout(r.checkUsername);
                        v.errTip.hide();
                    ...
                    if (l.ctls.mobile.msg.state && l.ctls.mobile.msg.type == "ok") {
                        ...
                        p = a.common.setting.timer({time: 59}, function (a) {
                        ...
                        e.getTrans("send_sms", {
                            onComplete: function (a) {
                                var b = {activation: {state: !1, msg: a.msg}};
                                if (a.retcode == 2e7) {
                                    b = {activation: {state: !1, msg: g.TIPS.SEND_SMS_SUCCESS}};
                                    v.errTip.show(b)
                                } else {
                        ...
                        }).request({entry: "weibo", mobile: b.value, s: s.unChecked})
                    } else v.errTip.show({mobile: l.ctls.mobile.msg}, 1);
                    typeof t == "function" && (t = null)
                }, destroy: function () {
                    v.stopCheckUsername();
                    v.errTip.hide();
                ...
                login: {
                    complete: function () {
                        ...
                        var b;
                        j(a.code) ? b = c(g.ERRTIP.CODE["" + a.code], {USERNAME: l.ctls.mobile.value()}) : b = a.reason;
                        if (a.code == "101") {
                            a.type = "activation";
    ...
    STK.register("pl.login.joker.source.main", function (a) {
        var b = a.core.util.URL(window.location.href).getHash("type");
        return function (c) {
            var d, e, f = {
                normal: null,
                qrcode: null,
                desktop: null,
                message: null
            }, g = a.common.channel.sso.desktop, h = {
                init: function () {
                    h.parseDOM();
                    h.bind();
                    h.checkState()
                    ...
                    e = a.core.evt.delegatedEvent(c);
                    e.add("switchTab", "click", h.domEvts.switchTab)
                }, checkState: function () {
                    if (h.is64IE()) {
                        h.handle.form.normal();
                        a.setStyle(d.module_loading, "display", "none")
                    } else {
                        f.desktop = a.common.login.desktop(d.desktop_form);
                        a.custEvent.add(f.desktop, "desktop", function (c, e) {
                            a.setStyle(d.module_loading, "display", "none");
                            if (e) {
                                a.setStyle(d.btn_backto_desktop, "display", "");
                                h.handle.switchForm("desktop")
                            } else {
                                a.setStyle(d.btn_backto_desktop, "display", "none");
                                b && a.core.arr.inArray(b, ["qrcode", "message"]) ? h.handle.form[b]() : h.handle.form.normal()
                            }
                        })
                    }
                }, handle: {
                    form: {
                        desktop: function () {
                            h.handle.switchForm("desktop");
                            f.qrcode && a.custEvent.fire(f.qrcode, "disable");
                            f.normal && a.custEvent.fire(f.normal, "closeTip");
                            f.message && a.custEvent.fire(f.message, "disable");
                            f.desktop || (f.desktop = a.common.login.desktop(d.desktop_form));
                            a.custEvent.fire(f.desktop, "refresh")
                        }, qrcode: function () {
                            h.handle.switchForm("qrcode");
                            f.normal && a.custEvent.fire(f.normal, "closeTip");
                            f.message && a.custEvent.fire(f.message, "disable");
                            f.qrcode || (f.qrcode = a.common.login.qrcode(d.qrcode_form));
                            a.custEvent.fire(f.qrcode, "enable")
                        }, normal: function () {
                            h.handle.switchForm("normal");
                            f.qrcode && a.custEvent.fire(f.qrcode, "disable");
                            if (f.message) {
                                f.message.destroy();
                                f.message = null
                            }
                            f.normal || (f.normal = a.common.login.form(d.normal_form))
                        }, message: function () {
                            h.handle.switchForm("message");
                            f.qrcode && a.custEvent.fire(f.qrcode, "disable");
                            if (f.normal) {
                                f.normal.destroy();
                                f.normal = null
                            }
                            f.message || (f.message = a.common.login.message(d.message_form))
                        }
                    }, switchForm: function (b) {
                        a.setStyle(d.desktop_tab, "display", "none");
                        a.setStyle(d.normal_tab, "display", "none");
                        var c = [d.normal_tag, d.qrcode_tag, d.message_tag];
                        for (var e in c) {
                            a.setStyle(a.core.dom.firstChild(c[e]), "display", "");
                            a.setStyle(a.core.dom.lastChild(c[e]), "display", "none")
                        }
                        switch (b) {
                            case"normal":
                                a.setStyle(d.normal_tab, "display", "");
                                a.setStyle(a.core.dom.firstChild(d[b + "_tag"]), "display", "none");
                                a.setStyle(a.core.dom.lastChild(d[b + "_tag"]), "display", "");
                                break;
                            case"qrcode":
                                a.setStyle(d.normal_tab, "display", "");
                                a.setStyle(a.core.dom.firstChild(d[b + "_tag"]), "display", "none");
                            ...
                            case"message":
                                ...
                                break;
                            case"desktop":
                                a.setStyle(d.desktop_tab, "display", "");
                                break;
                            case"QN":
                                a.setStyle(d.normal_tab, "display", "");
                                return
                        }
                        for (var g in f)g != b && a.setStyle(d[g + "_form"], "display", "none");
                        a.setStyle(d[b + "_form"], "display", "");
                        a.setStyle(d.connect_form, "display", "none");
                        b != "desktop" && a.setStyle(d.connect_form, "display", "")
                    }
                }, domEvts: {
                    switchTab: function (b) {
                        a.preventDefault(b.evt);
                        h.handle.form[b.data.type]()
                    }
                }, is64IE: function () {
    ...
    STK.pageletM.register("pl.login.joker.index", function (a) {
        return a.pl.login.joker.source.main(a.E("pl_login_form"))
    });
    STK.register("pl.login.morelogin.source.main", function (a) {
        return function (b) {
            var c, d = {
                init: function () {
                    d.parseDOM();
                    ...
                    nodes = a.kit.dom.parseDOM(a.builder(b).list);
                    nodes.other && (c = a.core.dom.next(nodes.other))
                }, bind: function () {
                    nodes.other && a.addEvent(nodes.other, "click", d.domEvts.show)
                }, domEvts: {
                    show: function (b) {
                        a.preventDefault(b);
                        if (c.style.display == "none") {
                            c.style.display = "";
                            a.addClassName(nodes.other, "W_arrow_turn");
                            setTimeout(function () {
                                a.addEvent(document, "click", d.domEvts.hide)
                            }, 0)
                        }
                    }, hide: function (b) {
                        var e = a.fixEvent(b).target;
                        if (!a.core.dom.contains(c, e) && c.style.display == "") {
                            c.style.display = "none";
                            a.removeClassName(nodes.other, "W_arrow_turn");
                            a.removeEvent(document, "click", d.domEvts.hide)
                        }
                    }
                }
            }, e = {};
    ...
    STK.pageletM.register("pl.login.morelogin.index", function (a) {
        return a.pl.login.morelogin.source.main(a.E("pl_login_form"))
    });
    STK.register("pl.login.video.source.main", function (a) {
        return function (b, c) {
            if (!!a.core.dom.isNode(b)) {
                var d = a.kit.dom.parseDOM(a.builder(b).list), c = a.parseParam({
                    vid: "",
                    mpid: "",
                    autoPlay: 0
                }, a.core.json.queryToJson(d.player.getAttribute("action-data") || "")), e;
                a.core.io.scriptLoader({
    ...
    STK.register("pl.login.video.index", function (a) {
        var b = a.E("pl_login_video"), c = a.pl.login.video.source.main(b);
        return c
    });
    ...
    STK.register("kit.extra.jsPath", function (a) {
        var b = {path: $CONFIG.jsPath || "http://js.t.sinajs.cn/t5/", mPath: $CONFIG.mJsPath}, c, d = function () {
            c = [""];
    ...
    STK.register("pl.plugin.wbad.source.main", function (a) {
        return function () {
            ...
            if (b.length != 0) {
                var c = !1, d = document, e = d.createElement("script"), f = d.getElementsByTagName("script")[0];
                e.type = "text/javascript";
                e.charset = "utf-8";
                e.async = !0;
